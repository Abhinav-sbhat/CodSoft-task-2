...
responses = {
    r'hello|hi|hey': 'Hello! How can I helpyou?',
    r'how are you': 'I am fine',
    r'what is your name': 'I am ram.',
    r'bye|goodbye': 'Goodbye! thank you.',
    r'help': 'I can assist you with general information. Please ask your question.',
    r'\b(?:what|who)\s+is\s+your\s+(?:creator|developer)\b': 'I was by Abhi .',
